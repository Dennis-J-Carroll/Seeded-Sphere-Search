...
from seededsphere import SeededSphereSearch, EllipsoidalTransformation, HyperbolicTransformation, HybridSearchEngine
from seededsphere.evaluation import evaluate_search_performance, generate_test_data

def load_corpus(file_path='data/corpora/scifi_corpus.json'):
